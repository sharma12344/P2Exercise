...
public class Unit {
    ...
    String contentPrintTextFile(String filename) throws IOException {
        ...
        try {
            f = new File("/home/prateema/Documents/unitest2/src/main/java/com/stackroute/practice/file.txt");
        } catch (Exception e) {
    ...
    byte[] byteFileContent(String Filename) throws IOException {
        ...
        File file = new File("/home/prateema/Documents/unitest2/src/main/java/com/stackroute/practice/file.txt");
